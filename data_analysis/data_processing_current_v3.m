...
for g = 1:G
    ...
    for q = 1:Q
        ...
        %% 读取力的大小值
        filename1 = 'D:/Luoqi/fitts_law/ID_6_grip_force_Fmin_Fmax.csv';   %%% ID_6_single_finger_force_Fmin_Fmax       ID_6_grip_force_Fmin_Fmax.csv
...
%%  结果保存为.mat文件
save('S3_grip_fitts_data.mat');    % S3_single_finger_fitts_data    S3_grip_fitts_data
%cd \
